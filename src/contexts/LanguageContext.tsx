...
const translations: Record<Language, Translations> = {
  en: {
    ...
    status: {
      active: "Live Jackpot Active",
      upcoming: "Upcoming Round",
      ended: "Round Ended",
      paused: "Round Paused",
    },
    rewards: {
      ...
      grandJackpot: "Grand Prize",
      grandPrizeLabel: "One Big Prize",
      grandDesc: "The largest share of the prize pool goes to a single winner.",
      bigReward: "Big Reward Winner",
      bigDesc: "Second-tier rewards for runners-up",
      luckyWinner: "Airdrop to Lucky Participants",
      luckyAirdropLabel: "Lucky Airdrop",
      luckyDesc: "A portion of the liquidity pool is distributed to 3% of participants.",
      referral: "Referral Bonus",
      referralDesc: "Invite friends and earn 50% of their ticket purchases automatically",
    ...
    referral: {
      title1: "Referral ",
      title2: "Program",
      description: "Share revenue by inviting friends and your community. Earn more with every successful referral.",
      inviteTitle: "Invite Your Community",
      inviteDesc: "Share Lucky10 with friends, groups, and your audience to grow together.",
      earnTitle: "Earn 50% Revenue",
      earnDesc: "You receive 50% of the lottery income generated by your referrals.",
      badge: "Lottery revenue share for you",
      cta: "Get Referral Support",
    },
  },
  tr: {
    navbar: { 
    ...
    status: {
      active: "Canlı Jackpot Aktif",
      upcoming: "Yaklaşan Tur",
      ended: "Tur Sona Erdi",
      paused: "Tur Duraklatıldı",
    },
    rewards: {
      title1: "Oyun ",
      title2: "Ödülleri",
      description: "Her çekiliş ödülleri iki heyecan verici katmana dağıtır. Havuz ne kadar büyükse, kazançlar o kadar büyük.",
      grandJackpot: "Büyük Ödül",
      grandPrizeLabel: "Tek Büyük Ödül",
      grandDesc: "Ödül havuzunun en büyük kısmı tek bir kazanana gider.",
      bigReward: "Büyük Ödül Kazananı",
      bigDesc: "İkinciler için ikinci kademe ödüller",
      luckyWinner: "Şanslı Katılımcılara Airdrop",
      luckyAirdropLabel: "Şanslı Airdrop",
      luckyDesc: "Likidite havuzunun bir kısmı katılımcıların %3'üne dağıtılır.",
      referral: "Referans Bonusu",
      referralDesc: "Arkadaşlarını davet et, bilet alımlarının %50'sini otomatik olarak kazan",
    ...
    referral: {
      title1: "Referans ",
      title2: "Programı",
      description: "Arkadaşlarını ve topluluğunu davet ederek gelirden pay al. Her başarılı davette kazancın artsın.",
      inviteTitle: "Topluluğunu Davet Et",
      inviteDesc: "Lucky10'u arkadaşlarınla, gruplarınla ve kitlenle paylaş.",
      earnTitle: "Gelirin %50'si Senin",
      earnDesc: "Referanslarının ürettiği piyango gelirinin %50'sini alırsın.",
      badge: "Sana ait piyango gelir payı",
      cta: "Referans Desteği Al",
    },
  },
  ku: {
    navbar: { 
    ...
    status: {
      active: "جەکپۆتی ڕاستەوخۆ چالاکە",
      upcoming: "کێشانی داهاتوو",
      ended: "کێشان کۆتایی هاتووە",
      paused: "کێشان وەستا",
    },
    rewards: {
      title1: "خەڵاتی ",
      ...
      grandJackpot: "خەڵاتی گەورە",
      grandPrizeLabel: "یەک خەڵاتی گەورە",
      grandDesc: "گەورەترین بەش لە حەوزی خەڵات دەگات بە یەک براوە.",
      bigReward: "براوەی خەڵاتی گەورە",
      bigDesc: "خەڵاتی ئاستی دووەم بۆ دواکەوتووەکان",
      luckyWinner: "ئەیردراپ بۆ بەشداربووانی بەختەوەر",
      luckyAirdropLabel: "ئەیردراپی بەختەوەر",
      luckyDesc: "بەشێک لە حەوزی ناوکی بۆ 3% ی بەشداربووان دابەش دەکرێت.",
      referral: "بۆنەسی ئیحالە",
      referralDesc: "هاوڕێکان بانگهێشت بکە و 50% ی کڕینی بلیتەکانیان بە شێوەی ئۆتۆماتیکی وەربگرە",
    ...
    common: {
      backToHome: "گەڕانەوە بۆ پەڕەی سەرەکی",
    },
    referral: {
      title1: "بەرنامەی ",
      title2: "ئەحالة",
      description: "بە بانگهێشتکردنی هاوڕێکان و کۆمەڵگاکەت لە داهاتدا بەشدار دەبیت و پارە دەکەیت.",
      inviteTitle: "کۆمەڵگاکەت بانگهێشت بکە",
      inviteDesc: "Lucky10 هاوبەش بکە لەگەڵ هاوڕێکان و گرووپەکانت.",
      earnTitle: "50% ی داهات بۆ تۆیە",
      earnDesc: "50% ی داهاتی لۆتەرییەکە کە لە ڕێگەی ئەحالةت دێت دەوێت.",
      badge: "بەشێک لە داهاتی لۆتەری بۆ تۆ",
      cta: "پشتیوانی ئەحالة وەربگرە",
    },
  },
  fa: {
    navbar: { 
    ...
    status: {
      active: "جکپات زنده فعال است",
      upcoming: "دور بعدی در راه است",
      ended: "این دور پایان یافت",
      paused: "دور متوقف شده است",
    },
    rewards: {
      title1: "جوایز ",
      title2: "بازی",
      description: "هر قرعه‌کشی جوایز را در دو سطح هیجان‌انگیز توزیع می‌کند. هرچه استخر بزرگتر، بردها بزرگتر.",
      grandJackpot: "یک جایزه بزرگ",
      grandPrizeLabel: "یک جایزه بزرگ",
      grandDesc: "بیشترین حجم جایزه به یک نفر تعلق می‌گیرد.",
      bigReward: "برنده جایزه بزرگ",
      bigDesc: "جوایز سطح دوم برای نفرات بعدی",
      luckyWinner: "ایردراپ به خوش‌شانس‌ها",
      luckyAirdropLabel: "ایردراپ خوش‌شانس‌ها",
      luckyDesc: "بخشی از استخر نقدینگی به 3 درصد شرکت‌کنندگان تعلق می‌گیرد.",
      referral: "بونوس معرفی",
      referralDesc: "دوستانت را دعوت کن و 50% از خرید بلیت‌هایشان را به صورت خودکار دریافت کن",
    ...
    referral: {
      title1: "برنامه ",
      title2: "رفرال",
      description: "با دعوت دوستان و جامعه خود در درآمد شریک شوید و کسب درآمد کنید.",
      inviteTitle: "دعوت از دوستان",
      inviteDesc: "Lucky10 را با دوستان، گروه‌ها و جامعه‌تان به اشتراک بگذارید.",
      earnTitle: "50% درآمد برای شماست",
      earnDesc: "50% از درآمد لاتاریِ حاصل از معرفی‌های شما به شما تعلق می‌گیرد.",
      badge: "سهم درآمد لاتاری برای شما",
      cta: "پشتیبانی رفرال",
    },
  },
  ar: {
    ...
    status: {
      active: "الجاكبوت المباشر نشط",
      upcoming: "الجولة القادمة",
      ended: "انتهت الجولة",
      paused: "تم إيقاف الجولة",
    },
    rewards: {
      title1: "جوائز ",
      title2: "اللعبة",
      description: "كل سحب يوزع الجوائز عبر مستويين مثيرين. كلما كان الحوض أكبر، كانت الأرباح أكبر.",
      grandJackpot: "جائزة كبرى",
      grandPrizeLabel: "جائزة واحدة كبيرة",
      grandDesc: "أكبر حصة من حوض الجوائز تذهب إلى فائز واحد.",
      bigReward: "فائز الجائزة الكبرى",
      bigDesc: "جوائز المستوى الثاني للوصفاء",
      luckyWinner: "إيردروب للمشاركين المحظوظين",
      luckyAirdropLabel: "إيردروب المحظوظين",
      luckyDesc: "جزء من حوض السيولة يُوزّع على 3% من المشاركين.",
      referral: "مكافأة الإحالة",
      referralDesc: "ادعُ أصدقاءك واحصل تلقائياً على 50% من مشتريات تذاكرهم",
    ...
    referral: {
      title1: "برنامج ",
      title2: "الإحالة",
      description: "شارك في الدخل بدعوة أصدقائك ومجتمعك وابدأ في تحقيق الأرباح.",
      inviteTitle: "ادعُ مجتمعك",
      inviteDesc: "شارك Lucky10 مع الأصدقاء والمجموعات وجمهورك.",
      earnTitle: "50% من الدخل لك",
      earnDesc: "تحصل على 50% من دخل اليانصيب الناتج عن إحالاتك.",
      badge: "حصة من دخل اليانصيب لك",
      cta: "دعم الإحالة",
    },
  },
};
